...
class SupermercadoWeb {
    ...
    private fun iniciaSupermercado() {
        ...
        marcas = listOf(marcaNinho, marcaItambe, marcaNestle, marcaSadia, marcaSeara, marcaDelicia, marcaOvomaltine, marcaNescau, marcaToddy)

        generos = listOf(Genero.Leite, Genero.Achocolatado, Genero.Presunto)
        ...
        produtos = listOf(produtoLeiteNinho, produtoLeiteItambe, produtoNescau, produtoToddy, produtoPresuntoSadia, produtoPresuntoSeara)
        ...
        for (i in 1..10) {
            estoque.entraItem(
                ItemProduto(
                    "LNI$i",
                    Data(hoje.getDia(), hoje.getMes() + 2, hoje.getAno()), produtoLeiteNinho
                )
            )
            estoque.entraItem(
                ItemProduto(
                    "LIT$i",
                    Data(hoje.getDia(), hoje.getMes() + 3, hoje.getAno()), produtoLeiteItambe
                )
            )
            estoque.entraItem(
                ItemProduto(
